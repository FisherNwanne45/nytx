...
<body>
	...
	<h3>Dear $name,  </h3>
	<p>
The Status of your Tax Clearance  has been updated, find new information below
</p>
<h2> Current Status:   $dur </h2> <p>
<b> Requested Tax Type: </b> $status <br>
<b>Accrued Charges: </b>  $amt <br>
<b>Late Payment Penalty: </b>  $rate <br>
<b>Tax Duration: </b>  $paydate
<br><br></p>
  
Endeavour to contact us in case of any complaints or further inquiries. 
<br>
Thanks.<br><br>
<?php echo $country; ?> Tax Clearance. <br><br>
                            <hr>
                            <p><i>The content of this email is confidential and intended for the recipient specified in
                                    ...
                                    can ensure such a mistake does not occur in the future</i></p>
    </body>

</html>";
							$sub = "TAX Clearance - $name, New Status Ref. - $cid. ";

							$header = 'MIME-Version: 1.0' . "\r\n";
							$header .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
							$header .= 'From: <?php echo $country; ?> Tax Clearance <info@<?php echo $country; ?>tx.com>' . "\r\n";
						...
						<div class="module">
							<div class="module-head">
								<h3>Edit Clearance Details of <?php echo $row['name']; ?></h3>
							</div>
							<div class="module-body">
								...
								<form class="form-horizontal row-fluid" method="post" action="">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Clearance Number</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput"> Applicant Full Name</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput"> Applicant Home Address</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Applicant Home Country</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Applicant Occupation</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Late Payment Penalty</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Notification Message</label>
										<div class="controls">
